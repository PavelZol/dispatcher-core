...
public final class BasicCommandDispatcherImpl implements CommandDispatcher {
    private final Map<Class<?>, CommandHandler<?>> commandHandlersMap;

    private BasicCommandDispatcherImpl(Map<Class<?>, CommandHandler<?>> commandHandlersMap) {
    ...
    public static final class Builder {
        ...
        public CommandDispatcher build() {
            return new BasicCommandDispatcherImpl(commandHandlersMap);
        }
    }
}
